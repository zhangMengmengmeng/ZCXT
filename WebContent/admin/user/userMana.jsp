	...
	<head>
        ...
        <script language="javascript">
           ...
           function findById(userId){
        	   window.location.href="<%=path %>/findById.action?userId="+userId;
           }
       </script>
	</head>
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/img/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
						<s:property value="#user.userJiazhao"/>
					</td>
					<td bgcolor="#FFFFFF" align="center">
						<s:property value="#user.userCard"/>
					</td>
					<td bgcolor="#FFFFFF" align="center">
						<s:property value="#user.userLeixing"/>
					</td>
					<td bgcolor="#FFFFFF" align="center">
						<input type="button" value="删除" onclick="userDel(<s:property value="#user.userId"/>)" />
						<input type="button" value="修改" onclick="findById(<s:property value="#user.userId"/>)" />
					</td>
				</tr>
				</s:iterator>
			</table>
